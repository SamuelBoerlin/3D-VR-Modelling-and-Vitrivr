...
public struct TestArrayVoxelCell : IVoxelCell
{
    private static readonly CellEdgesLookup Edges = new CellEdgesLookup();

    private struct CellEdgesLookup
    {
        internal CellEdges this[int index]
        {
            get
            {
                switch (index)
                {
                    ...
                    case 0:
                        //ZNeg
                        return new CellEdges(16, 17, 18, 19);
                    case 1:
                        //XPos
                        return new CellEdges(4, 5, 6, 7);
                    case 2:
                        //ZPos
                        return new CellEdges(20, 21, 22, 23);
                    case 3:
                        //XNeg
                        return new CellEdges(0, 1, 2, 3);
                    case 4:
                        //YNeg
                        return new CellEdges(8, 9, 10, 11);
                    case 5:
                        //YPos
                        return new CellEdges(12, 13, 14, 15);
                }
            }
        }
    }
    ...
    public TestArrayVoxelCell(int index, float3 pos, NativeArray<int> materials, NativeArray<float> intersections, NativeArray<float3> normals)
    {
        this.index = index;
        this.pos = pos;
